...
export default function GlassmorphismEngine() {
  ...
  const wMap   = {card:280,navbar:"100%",modal:300,button:"auto"};
  ...
  return (
    <div style={{minHeight:"100vh",fontFamily:"-apple-system,BlinkMacSystemFont,'SF Pro Display','Segoe UI',sans-serif",overflow:"hidden",position:"relative"}}>
      ...
      <div style={{position:"relative",zIndex:1,display:"flex",flexDirection:"column",gap:10,padding:14,minHeight:"100vh"}}>
        ...
        <div style={{...panel,padding:"12px 16px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:8,animation:"fadeIn .3s ease"}}>
          ...
          <div style={{display:"flex",gap:6,flexWrap:"wrap",alignItems:"center"}}>
            <button className="ge-btn" onClick={undo} disabled={!history.length} style={{...panel,border:"none",cursor:"pointer",padding:"7px 12px",color:txtPri,fontSize:12,display:"flex",alignItems:"center",gap:5}}><Undo2 size={13}/> Undo <span style={{fontSize:10,opacity:.6}}>⌘Z</span></button>
        ...
        <div style={{...panel,padding:"13px 18px",animation:"fadeIn .35s ease .05s both"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
            ...
            <button onClick={()=>setUserPresets(p=>[...p,{id:`u${Date.now()}`,name:`Custom ${p.length+1}`,...valsRef.current}])} style={{...panel,border:"none",cursor:"pointer",padding:"5px 10px",color:accent,fontSize:11,display:"flex",alignItems:"center",gap:4}}>
              <Plus size={11}/> Save Current <span style={{fontSize:10,opacity:.6}}>⌘S</span>
            </button>
          </div>
        ...
        <div style={{display:"grid",gridTemplateColumns:"265px 1fr",gap:10,flex:1}}>

          <div style={{...panel,padding:"16px 18px",display:"flex",flexDirection:"column",gap:13,animation:"fadeIn .4s ease .1s both",overflowY:"auto",maxHeight:640}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:10}}>
            ...
            <div style={{...panel,padding:"16px 18px",animation:"fadeIn .4s ease .12s both"}}>
              ...
              <div ref={previewRef} style={{display:"flex",justifyContent:"center",alignItems:"center",gap:24,padding:"12px 0",flexWrap:"wrap",minHeight:140}}>
                {compare&&(
                  <div>
